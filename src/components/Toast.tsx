...
export function Toast({ id, message, type = 'info', duration = 3000, onClose }: ToastProps) {
  ...
  return (
    <div
      className={`flex items-center gap-3 px-4 py-3 rounded-lg border shadow-lg transition-all duration-300 ${colors[type]} ${
...
export function ToastContainer({ toasts }: { toasts: ToastProps[] }) {
  return (
    <div className="fixed bottom-4 right-4 z-[999] flex flex-col gap-2 max-w-sm w-full">
      {toasts.map((toast) => (
