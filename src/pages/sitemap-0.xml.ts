...
export const GET: APIRoute = async ({ site }) => {
  ...
  const staticPages = [
    ...
    { url: 'ai-tools', changefreq: 'daily', priority: '0.9', lastmod: new Date().toISOString() },
    { url: 'compare', changefreq: 'weekly', priority: '0.7', lastmod: new Date().toISOString() },
    { url: 'privacy', changefreq: 'yearly', priority: '0.5', lastmod: new Date().toISOString() },
    { url: 'terms', changefreq: 'yearly', priority: '0.5', lastmod: new Date().toISOString() },
    { url: 'disclaimer', changefreq: 'yearly', priority: '0.5', lastmod: new Date().toISOString() }
  ];
