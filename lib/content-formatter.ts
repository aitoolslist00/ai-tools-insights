...
export function enhanceContentFormatting(html: string): string {
  ...
  // Important: Add styling to strong/bold tags (these are generated by marked)
  // We use minimal classes here and let CSS handle the rendering
  result = result.replace(/<strong>/g, '<strong style="font-weight: 700;">');
  result = result.replace(/<b>/g, '<b style="font-weight: 700;">');
