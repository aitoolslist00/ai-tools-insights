import { f as createComponent, k as renderComponent, r as renderTemplate, m as maybeRenderHead } from '../chunks/astro/server_t80nOXy5.mjs';
...
const $$Compare = createComponent(($$result, $$props, $$slots) => {
  return renderTemplate`${renderComponent($$result, "BaseLayout", $$BaseLayout, { "title": "Compare AI Tools | AI Tools Insights", "description": "Compare AI tools side-by-side to find the perfect solution for your needs. Interactive comparison matrix with detailed feature analysis.", "data-astro-cid-zfc4wkwq": true }, { "default": ($$result2) => renderTemplate`  ${maybeRenderHead()}<section class="section-padding container-custom" data-astro-cid-zfc4wkwq> <div class="max-w-7xl mx-auto" data-astro-cid-zfc4wkwq> <div class="text-center mb-12 animate-fade-in" data-astro-cid-zfc4wkwq> <h1 class="text-4xl md:text-5xl font-bold mb-6" data-astro-cid-zfc4wkwq>
Compare <span class="gradient-text" data-astro-cid-zfc4wkwq>AI Tools</span> </h1> <p class="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto" data-astro-cid-zfc4wkwq>
Make informed decisions with our interactive comparison tool. Compare features, pricing, and capabilities side-by-side.
</p> </div> ${renderComponent($$result2, "ToolComparison", ToolComparison, { "client:load": true, "client:component-hydration": "load", "client:component-path": "F:/my work/programming/vercel/ai-tools-update/src/components/ToolComparison", "client:component-export": "default", "data-astro-cid-zfc4wkwq": true })} <div class="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8" data-astro-cid-zfc4wkwq> <div class="card p-6 text-center animate-scale-in" data-astro-cid-zfc4wkwq> <div class="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-blue-500 to-blue-600 rounded-2xl flex items-center justify-center" data-astro-cid-zfc4wkwq> <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-astro-cid-zfc4wkwq> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" data-astro-cid-zfc4wkwq></path> </svg> </div> <h3 class="text-xl font-bold mb-2" data-astro-cid-zfc4wkwq>Side-by-Side</h3> <p class="text-gray-600 dark:text-gray-400" data-astro-cid-zfc4wkwq>
Compare up to 3 tools simultaneously with detailed feature breakdowns
</p> </div> <div class="card p-6 text-center animate-scale-in animation-delay-200" data-astro-cid-zfc4wkwq> <div class="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-purple-500 to-purple-600 rounded-2xl flex items-center justify-center" data-astro-cid-zfc4wkwq> <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-astro-cid-zfc4wkwq> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 10V3L4 14h7v7l9-11h-7z" data-astro-cid-zfc4wkwq></path> </svg> </div> <h3 class="text-xl font-bold mb-2" data-astro-cid-zfc4wkwq>Real-Time Updates</h3> <p class="text-gray-600 dark:text-gray-400" data-astro-cid-zfc4wkwq>
Get the latest information on features, pricing, and capabilities
</p> </div> <div class="card p-6 text-center animate-scale-in animation-delay-400" data-astro-cid-zfc4wkwq> <div class="w-16 h-16 mx-auto mb-4 bg-gradient-to-br from-pink-500 to-pink-600 rounded-2xl flex items-center justify-center" data-astro-cid-zfc4wkwq> <svg class="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24" data-astro-cid-zfc4wkwq> <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" data-astro-cid-zfc4wkwq></path> </svg> </div> <h3 class="text-xl font-bold mb-2" data-astro-cid-zfc4wkwq>Detailed Analysis</h3> <p class="text-gray-600 dark:text-gray-400" data-astro-cid-zfc4wkwq>
Comprehensive feature matrix to help you make the right choice
</p> </div> </div> <div class="mt-16 card p-8 md:p-12 text-center bg-gradient-to-br from-blue-50 to-purple-50 dark:from-blue-900/20 dark:to-purple-900/20" data-astro-cid-zfc4wkwq> <h2 class="text-3xl font-bold mb-4" data-astro-cid-zfc4wkwq>Need Help Choosing?</h2> <p class="text-lg text-gray-600 dark:text-gray-400 mb-6 max-w-2xl mx-auto" data-astro-cid-zfc4wkwq>
Check out our detailed reviews and guides to learn more about each tool and find the perfect fit for your needs.
</p> <div class="flex flex-col sm:flex-row justify-center gap-4" data-astro-cid-zfc4wkwq> <a href="/ai-tools" class="btn btn-primary" data-astro-cid-zfc4wkwq>
Browse All Tools
</a> <a href="/blog" class="btn btn-outline" data-astro-cid-zfc4wkwq>
Read Reviews
</a> </div> </div> </div> </section>  `, "footer": ($$result2) => renderTemplate`${renderComponent($$result2, "Footer", $$Footer, { "slot": "footer", "data-astro-cid-zfc4wkwq": true })}`, "header": ($$result2) => renderTemplate`${renderComponent($$result2, "Header", $$Header, { "slot": "header", "data-astro-cid-zfc4wkwq": true })}` })} `;
